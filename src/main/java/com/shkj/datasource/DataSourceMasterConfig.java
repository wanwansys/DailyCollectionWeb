...
//密码，表，以及事务处理之类的。
@MapperScan(basePackages= {"com.shkj.mapper"},sqlSessionFactoryRef="masterSqlSessionFactory")
public class DataSourceMasterConfig {
	
	@Bean(name="masterDataSource")//注入到这个容器
    @ConfigurationProperties(prefix="spring.datasource.databasemaster")//表示取application.properties配置文件中的前缀
